...
COST_THR = 10000  # cost thresholding for removing false tracks: no rejection right now: no rejection right now
WGT_CNN = 1  # weight on cnn features
WGT_IOU = 1  # weight on iou
WGT_BOX = 1  # weight on box ratio
WGT_DIS = 1  # weight on distance ratio
